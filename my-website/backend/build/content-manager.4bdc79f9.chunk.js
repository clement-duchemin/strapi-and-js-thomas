...
var Menu = __webpack_require__(89789);
...
const Image = ({ attributes, children, element }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { ...attributes }, children, /* @__PURE__ */ react.createElement(Box/* Box */.x, { contentEditable: false }, /* @__PURE__ */ react.createElement(Img, { src: url, alt: alternativeText, width, height })));
};
Image.propTypes = {
  attributes: (prop_types_default()).object.isRequired,
  children: (prop_types_default()).node.isRequired,
...
const handleEnterKeyOnList = (editor) => {
  ...
  const isEmptyListItem = currentListItem.children.length === 1 && currentListItem.children[0].text === "";
  if (isEmptyListItem) {
  ...
  return {
    paragraph: {
      ...
      handleEnterKey(editor) {
        ...
        const [createdNode] = index_es/* Editor */.ML.parent(editor, editor.selection.anchor.path);
        ...
        index_es/* Transforms */.YR.select(editor, editor.start(editor.selection.anchor.path.slice(0, -1)));
      }
    },
    "heading-one": {
    ...
    link: {
      renderElement: (props) => /* @__PURE__ */ react.createElement(BaseLink/* BaseLink */.f, { href: props.element.url, ...props.attributes }, props.children),
      value: {
        type: "link"
      },
...
BlocksInput.propTypes = {
  readOnly: (prop_types_default()).bool.isRequired
};
...
var dist = __webpack_require__(10527);
...
const Separator = (0,styled_components_browser_esm/* default */.ZP)(dist/* Separator */.Z0)`
...
const ToolbarButton = ({ icon, name, label, isActive, handleClick }) => {
  ...
  return /* @__PURE__ */ react.createElement(Tooltip/* Tooltip */.u, { description: labelMessage }, /* @__PURE__ */ react.createElement(dist/* ToggleItem */.HP, { value: name, "data-state": isActive ? "on" : "off", asChild: true }, /* @__PURE__ */ react.createElement(
    FlexButton,
    {
    ...
    /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { width: 3, height: 3, as: icon, color: isActive ? "primary600" : "neutral600" })
  )));
};
...
const isBlockActive = (editor, matchNode) => {
  ...
  const match = Array.from(
    index_es/* Editor */.ML.nodes(editor, {
      ...
      match: (n) => !index_es/* Editor */.ML.isEditor(n) && index_es/* Element */.W_.isElement(n) && matchNode(n)
    })
  );
...
const toggleBlock = (editor, value) => {
  ...
  index_es/* Transforms */.YR.setNodes(editor, newProperties);
};
  ...
  const handleSelectAssets = (images) => {
    const formattedImages = images.map((image) => {
      ...
      return {
        ...
        url: (0,helper_plugin_esm/* prefixFileUrlWithBackendUrl */.CR)(image.url)
      };
    });
...
const isLastBlockImageOrCode = (editor) => {
  ...
  if (!selection)
    return false;
  const [currentImageORCodeBlock] = index_es/* Editor */.ML.nodes(editor, {
    at: selection,
...
BlockOption.propTypes = {
  ...
  handleSelection: (prop_types_default()).func.isRequired,
...
const AlphaTag = (0,styled_components_browser_esm/* default */.ZP)((0,Box/* Box */.x))`
...
const BlocksToolbar = () => {
  const modifiers = useModifiersStore();
  return /* @__PURE__ */ react.createElement(dist/* Root */.fC, { asChild: true }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1, padding: 2, paddingRight: 4, width: "100%" }, /* @__PURE__ */ react.createElement(BlocksDropdown, null), /* @__PURE__ */ react.createElement(Separator, null), /* @__PURE__ */ react.createElement(dist/* ToggleGroup */.tX, { type: "multiple", asChild: true }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1 }, Object.entries(modifiers).map(([name, modifier]) => /* @__PURE__ */ react.createElement(
    ToolbarButton,
    {
      key: name,
      name,
  ...
  )))), /* @__PURE__ */ react.createElement(Separator, null), /* @__PURE__ */ react.createElement(dist/* ToggleGroup */.tX, { type: "single", asChild: true }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1 }, /* @__PURE__ */ react.createElement(
    ListButton,
    {
      label: {
  ...
  ))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { grow: 1, justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(AlphaTag, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "warning600", variant: "sigma" }, "ALPHA")))));
};
...
const BlocksEditor = react.forwardRef(
  ({ intlLabel, name, readOnly, required, error, value, onChange }, ref) => {
    const { formatMessage } = (0,useIntl/* default */.Z)();
    const [editor] = react.useState(() => (0,slate_react_dist_index_es/* withReact */.BU)((0,dist_index_es/* withHistory */.VC)((0,index_es/* createEditor */.Jh)())));
    ...
    return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 1 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", fontWeight: "bold", textColor: "neutral800" }, label, required && /* @__PURE__ */ react.createElement(TypographyAsterisk, { textColor: "danger600" }, "*"))), /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(FieldInput/* InputWrapper */.S, { direction: "column", alignItems: "flex-start" }, /* @__PURE__ */ react.createElement(BlocksToolbar, null), /* @__PURE__ */ react.createElement(EditorDivider, { width: "100%" }), /* @__PURE__ */ react.createElement(BlocksEditor_Wrapper, null, /* @__PURE__ */ react.createElement(BlocksEditor_BlocksInput, { readOnly })))
    )), error && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "danger600", "data-strapi-field-error": true }, error)));
  }
);
...
const InputUID = react.forwardRef(
  ({
    ...
    const { modifiedData, initialData } = (0,helper_plugin_esm/* useCMEditViewDataManager */.Wq)();
    const toggleNotification = (0,helper_plugin_esm/* useNotification */.lm)();
...
const Wysiwyg_Wysiwyg = (0,react.forwardRef)(
  ({ hint, disabled, error, intlLabel, labelAction, name, onChange, placeholder, value, required }, forwardedRef) => {
    ...
    return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 1 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", fontWeight: "bold", textColor: "neutral800" }, label, required && /* @__PURE__ */ react.createElement(Wysiwyg_TypographyAsterisk, { textColor: "danger600" }, "*")), labelAction && /* @__PURE__ */ react.createElement(LabelAction, { paddingLeft: 1 }, labelAction)), /* @__PURE__ */ react.createElement(
      EditorLayout,
      {
        isExpandMode,
        error,
